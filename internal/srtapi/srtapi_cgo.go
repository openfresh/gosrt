...
func accept(s int, rsa *syscall.RawSockaddrAny, addrlen *_Socklen) (fd int, err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_accept")
	}
	return
}
...
func getsockname(s int, rsa *syscall.RawSockaddrAny, addrlen *_Socklen) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_getsockname")
	}
	return
}
...
func getpeername(s int, rsa *syscall.RawSockaddrAny, addrlen *_Socklen) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_getpeername")
	}
	return
}
...
func bind(s int, addr unsafe.Pointer, addrlen _Socklen) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_bind")
	}
	return
}
...
func connect(s int, addr unsafe.Pointer, addrlen _Socklen) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_connect")
	}
	return
}
...
func socket(domain int, typ int, proto int) (fd int, err error) {
	...
	if fd == SRT_ERROR {
		err = util.GetLastError("srt_socket")
	}
	return
}
...
func getsockopt(s int, level int, name int, val unsafe.Pointer, vallen *_Socklen) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_getsockopt")
	}
	return
}
...
func setsockopt(s int, level int, name int, val unsafe.Pointer, vallen uintptr) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_setsockopt")
	}
	return
}
...
func Listen(s int, n int) (err error) {
	...
	if stat == SRT_ERROR {
		err = util.GetLastError("srt_listen")
	}
	return
}
...
func read(fd int, p []byte) (n int, err error) {
	...
	n = int(r0)
	if r0 == SRT_ERROR {
		err = util.GetLastError("srt_recv")
	}
	return
}
...
func write(fd int, p []byte) (n int, err error) {
	...
	n = int(r0)
	if r0 == SRT_ERROR {
		err = util.GetLastError("srt_send")
	}
	return
}
